...
import { ArrowRight, Compass, Eye, EyeOff, Mail, Lock, } from "lucide-react";

import { CompassRose } from "../components/CompassRose";
import { singUp, singIn } from "../services/auth";
...
export function AuthPage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center bg-[#0D0D0D] p-6 text-[#E7E5E1] lg:p-10">
            <div className="grid min-h-[640px] w-full max-w-[1360px] overflow-hidden rounded-2xl border border-[#242424] bg-[#141414] shadow-2xl lg:grid-cols-2">
                ...
                <div className="relative flex flex-col justify-between overflow-hidden border-b border-[#242424] bg-[#111111] p-10 lg:border-b-0 lg:border-r lg:p-16">
                    ...
                    <div className="flex justify-end">
                        <div className="flex rounded-xl border border-[#262626] bg-[#0E0E0E] p-1.5 font-mono text-xs">
                            ...
                            <button
                                ...
                                className={`rounded-lg px-5 py-2 font-semibold transition-all ${mode === "signup"
                            ...
                            <button
                                ...
                                className={`rounded-lg px-5 py-2 font-semibold transition-all ${mode === "login"
                                    ? "bg-[#C96B62] text-white shadow"
                                    : "text-[#777770] hover:text-white"
                                    }`}>
                                Log In
                    ...
                    <div className="mx-auto my-auto w-full max-w-lg py-6">
                        ...
                        <form onSubmit={handleSubmit} noValidate className="mt-8 space-y-4">
                            ...
                            <div>
                                <div className="flex items-center justify-between">
                                    ...
                                    {mode === "login" && (
                                        <button
                                            type="button"
                                            className="text-xs text-[#777770] transition-colors hover:text-[#C96B62]"
                                        >
                                            Forgot password?
                                        </button>
                                    )}
                                ...
                                <div className="mt-2 flex items-center gap-3.5 rounded-xl border border-[#262626] bg-[#0E0E0E] px-4 py-3.5 transition-colors focus-within:border-[#C96B62]">
                                    ...
                                    <button
                                        ...
                                        className="text-[#666660] transition-colors hover:text-white">
                            ...
                            <button type="submit" disabled={loading}
                                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-[#C96B62] py-4 text-sm font-semibold text-white shadow-lg shadow-[#C96B62]/10 transition-colors hover:bg-[#B85C55] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-70">
                                {loading
                                    ? mode === "signup"
                                        ? "Creating Account..."
                                        : "Logging In..."
