...
// import { firstLetterName } from "../pages/settings";
                        ...
                        <div className="flex min-w-0 items-center">
                            ...
                            <div className="flex h-9 w-[44px] shrink-0 items-center justify-center">
                                {user?.user_metadata?.avatar_url ? (
                                    ...
                                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#6D3833] text-sm font-semibold text-white">
                                        {/* {firstLetterName} */}
                                    </div>
                                )}
                            </div>
