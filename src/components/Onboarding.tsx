...
export default function Onboarding() {
    ...
    const levels: LevelOption[] = [
        {
            id: "A1",
            title: "Beginner",
            description: "I can understand and use very basic words, greetings and simple expressions.",
        },
        {
            id: "A2",
            title: "Elementary",
            description: "I can understand simple sentences and communicate in familiar everyday situations.",
        },
        {
            id: "B1",
            title: "Intermediate",
            description: "I can talk about familiar topics, experiences and everyday situations.",
        },
        {
            id: "B2",
            title: "Upper Intermediate",
            description: "I can communicate with confidence and understand more complex conversations and texts.",
        },
        {
            id: "unsure",
            title: "I'm not sure",
            description: "That's okay. We'll help you discover the right starting point.",
        },
    ]
    ...
    const motivations: MotivationOption[] = [
        {
            id: "travel",
            title: "Travel",
            description: "I want to communicate in English when traveling.",
        },
        {
            id: "work",
            title: "Work",
            description: "I want to use English in my professional life.",
        },
        {
            id: "study",
            title: "Study",
            description: "I want to study or access content in English.",
        },
        {
            id: "communication",
            title: "Communication",
            description: "I want to communicate with people from other countries.",
        },
        {
            id: "personal-development",
            title: "Personal Development",
            description: "I want to improve myself and learn English.",
        },
        {
            id: "other",
            title: "Other",
            description: "I have another reason for learning English.",
        },
    ]
    ...
    const skillOptions: SkillType[] = ["speaking", "listening", "reading", "writing"]
    ...
    const handleCreateJourney = async () => {
        ...
        try {
            setIsLoading(true);
            console.log("Disparando requisição para o backend...");
            ...
            console.log("JORNADA RECEBIDA DO BACKEND:", dailyJourney);

            // Salve no estado ou navegue para a tela com a jornada pronta!
        } catch (error) {
            console.error("Falha ao criar jornada:", error);
            alert("Erro ao conectar com o servidor da IA. Verifique se o server está rodando.");
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <section className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-10">
            ...
            <div className="flex-1">
                    ...
                    <div>
                        <div className="mb-8">
                            ...
                            <p className="mt-3 max-w-2xl text-[#999994]">
                                Choose the option that best represents your current skills and confidence.
                            </p>
                        </div>
                ...
                {step === 2 && (
                    <div>
                        <div>
                            <p className="text-sm font-medium text-[#C96B62]">STEP 2</p>
                            <h2 className="mt-2 text-3xl font-bold">Why do you want to learn English?</h2>
                            <p className="mt-3 max-w-2xl text-[#999994]">
                                Choose the reasons that best describe why English is important to you.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 grid gap-4 sm:grid-cols-2">
                            {motivations.map((motivation) => {
                                ...
                                return (
                                        ...
                                        onClick={() =>
                                            setSelectedMotivations((current) => {
                                                if (current.includes(motivation.id)) {
                                                    return current.filter((id) => id !== motivation.id)
                                                }
                                                return [...current, motivation.id]
                                            })
                                        }
                                    ...
                                    >
                                        <h3 className="font-semibold">{motivation.title}</h3>
                                        <p className="mt-2 text-sm leading-relaxed text-[#999994]">
                ...
                {step === 3 && (
                    <div>
                        <div className="mb-8">
                            ...
                            <h2 className="mt-2 text-3xl font-bold">What would you like to be able to do?</h2>
                ...
                {step === 4 && (
                    <div>
                        <div className="mb-8">
                            ...
                            <h2 className="mt-2 text-3xl font-bold">How much time can you realistically study?</h2>
                            <p className="mt-3 max-w-2xl text-[#999994]">
                ...
                {step === 5 && (
                    <div>
                        <div className="mb-8">
                            ...
                            <h2 className="mt-2 text-3xl font-bold">How comfortable are you with each skill?</h2>
                            <p className="mt-3 max-w-2xl text-[#999994]">
                                Tell us how you feel about each skill and choose up to two priorities.
                            </p>
                        </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            >
                                                {data.priority ? "Priority" : "Make priority"}
                                            </button>
                                        </div>
                                            ...
                                            {(
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        setSkills((current) => ({
                                                            ...current,
                                                            [skill]: { ...current[skill], confidence: value },
                                                        }))
                                                    }}
                ...
                {step === 6 && (
                    <div>
                        ...
                        {studiedBefore === true && (
                            <>
                                <div className="mt-8">
                                    <h3 className="mb-4 font-semibold">How did you study?</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {studyExperiences.map((experience) => {
                                            const selected = studyExperience === experience
                                            return (
                                                <button
                                                    key={experience}
                                                    type="button"
                                                    onClick={() => setStudyExperience(experience)}
                                ...
                                <div className="mt-8">
                                    <h3 className="mb-4 font-semibold">For how long?</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {studyDurations.map((duration) => {
                                            const selected = studyDuration === duration
                                            return (
                                                <button
                                                    key={duration}
                                                    type="button"
                ...
                {step === 7 && (
                    <div>
                        <div className="mb-8">
                            ...
                            <h2 className="mt-2 text-3xl font-bold">Here's what we learned about you.</h2>
                            <p className="mt-3 max-w-2xl text-[#999994]">
                        ...
                        <div className="space-y-4">
                            <div className="rounded-2xl border border-[#2B2B2B] bg-[#1D1D1D] p-5">
                                <p className="text-sm text-[#777770]">Your level</p>
                                <h3 className="mt-1 font-semibold">{selectedLevel ?? "Not specified"}</h3>
                            </div>

                            <div className="rounded-2xl border border-[#2B2B2B] bg-[#1D1D1D] p-5">
                                <p className="text-sm text-[#777770]">Why you want to learn English</p>
                                <div className="mt-3 flex flex-wrap gap-2">
                                    {selectedMotivations.length > 0 ? (
                                        ...
                                        <span className="text-sm text-[#999994]">None selected</span>
                                    )}
                                </div>
                            </div>

                            <div className="rounded-2xl border border-[#2B2B2B] bg-[#1D1D1D] p-5">
                                <p className="text-sm text-[#777770]">What you want to be able to do</p>
                                <div className="mt-3 flex flex-wrap gap-2">
                            ...
                            <div className="rounded-2xl border border-[#2B2B2B] bg-[#1D1D1D] p-5">
                                <p className="text-sm text-[#777770]">Your study routine</p>
                                <h3 className="mt-1 font-semibold">
                                    {dailyMinutes !== null && daysPerWeek !== null
                            ...
                            <div className="rounded-2xl border border-[#2B2B2B] bg-[#1D1D1D] p-5">
                                <p className="text-sm text-[#777770]">Previous experience</p>
                                <h3 className="mt-1 font-semibold">
                                    {studiedBefore === null ? "Not set" : studiedBefore ? "Yes" : "No"}
                                </h3>
                                {studiedBefore && (
                                    <p className="mt-1 text-sm text-[#999994]">
                                        {studyExperience ?? "N/A"} · {studyDuration ?? "N/A"}
                                    </p>
                                )}
                            </div>
                        </div>
                ...
                {step < totalSteps ? (
                    <button
                        ...
                        disabled={
                            ...
                            (step === 5 &&
                                !Object.values(skills).every((skill) => skill.confidence !== null)) ||
                            (step === 6 &&
                                (studiedBefore === null ||
                                    (studiedBefore === true &&
                                        (studyExperience === null || studyDuration === null))))
                        }
                        onClick={() => setStep((current) => Math.min(current + 1, totalSteps))}
                        className="rounded-xl bg-[#B85C55] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#C96B62] disabled:opacity-50"
                    >
                        Continue
                    </button>
                ) : (
